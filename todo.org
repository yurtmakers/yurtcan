...
#+PROPERTY: Pomodoro x - '
#+TAGS: { étude(e) model(m) construction(c) nettoyage(n) achat(a) }
#+TAGS: achat(a)
#+COLUMNS: %TODO %Status %PRIORITY %50ITEM %10TAGS %Pomodoro %Estimation %Real %15SCHEDULED %15DEADLINE
#
...
** ACTIVITY Modèlisation					      :model:
   ...
   :END:
* Mezzanine
** ACTIVITY Réflexion (appel ayhan)				      :étude:
   SCHEDULED: <2013-01-12 sam.>
   - State "ACTIVITY"   from "TODO"       [2013-01-13 dim. 18:13]
   :PROPERTIES:
   :Estimation: 2
